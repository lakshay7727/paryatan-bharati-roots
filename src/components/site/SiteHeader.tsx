...
const navLinks = [
  ...
  { label: "States", to: "/states" as const },
  { label: "Temples", to: "/temples" as const },
  { label: "Heritage", to: "/heritage" as const },
  { label: "Festivals", to: "/festivals" as const },
  { label: "Food", to: "/food" as const },
  { label: "Sports", to: "/sports" as const },
  { label: "Students", to: "/students" as const },
  { label: "Government", to: "/government" as const },
